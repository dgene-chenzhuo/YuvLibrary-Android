...
JNIEXPORT void JNICALL Java_com_libyuv_util_YuvUtil_yuvCropI420
        (JNIEnv *, jclass, jbyteArray, jint, jint, jint, jbyteArray, jint, jint, jint, jint, jint);
...
/*
 * Class:     com_libyuv_util_YuvUtil
 * Method:    yuvAndroid420ToI420
 * Signature: ([BII[BII[BIII[BII[BII[BIIII)V
 */
JNIEXPORT jint JNICALL Java_com_libyuv_util_YuvUtil_yuvAndroid420ToI420___3BII_3BII_3BIII_3BII_3BII_3BIIII
        (JNIEnv *, jclass, jbyteArray, jint, jint, jbyteArray, jint, jint, jbyteArray, jint, jint, jint, jbyteArray, jint, jint, jbyteArray, jint, jint, jbyteArray, jint, jint, jint, jint);

/*
 * Class:     com_libyuv_util_YuvUtil
 * Method:    yuvAndroid420ToI420
 * Signature: (Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;ILjava/nio/ByteBuffer;II[BII[BII[BIIII)V
 */
JNIEXPORT jint JNICALL Java_com_libyuv_util_YuvUtil_yuvAndroid420ToI420__Ljava_nio_ByteBuffer_2ILjava_nio_ByteBuffer_2ILjava_nio_ByteBuffer_2II_3BII_3BII_3BIIII
        (JNIEnv *, jclass, jobject, jint, jobject, jint, jobject, jint, jint, jbyteArray, jint, jint, jbyteArray, jint, jint, jbyteArray, jint, jint, jint, jint);
#ifdef __cplusplus
}
#endif
#endif
